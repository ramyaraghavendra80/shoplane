...
function Cart(props) {
    ...
    const { AddToCart, cartItem, FavItem } = props
    ...
    {cartItem.length>0?cartItem.map((item,index)=>{
        return( <div class="card" id='1'  key={index}>
        <svg onClick={()=>FavItem(item)} xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-heart" viewBox="0 0 16 16">
